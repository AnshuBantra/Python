...
def main():
    ...
    csv_file_location = r'..\data\user_emails.csv'
    report_file = r'..\data'+r'\updated_user_emails.csv'
    user_email_list = []
    ...
    with open(csv_file_location, 'r') as f:
        ...
        user_email_list = [data[1].strip() for data in user_data_list[2:]]
    ...
    email_index = user_data_list[2].index(email_key)

    for user in user_data_list[2:]:
